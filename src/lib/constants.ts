...
// US states topojson (us-atlas states-10m). Features carry a 2-digit FIPS `id`
// and `properties.name`; USA_STATES maps that FIPS id to the ISO 3166-2 `US-XX`
// region code stored on session.region, so the choropleth can match its data.
export const USA_MAP_FILE = '/datamaps.usa-states.json';
